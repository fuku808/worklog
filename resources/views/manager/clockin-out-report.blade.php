        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('management.clockin-out.report') }}" class="form" method="GET">
                <div class="flex sm:items-center flex-col sm:flex-row px-2 mb-4">
                    <label class="block sm:w-1/12 sm:text-right mb-1 pr-4" for="date_from">From</label>
                    ...
                    <label class="block sm:w-1/12 sm:text-right mb-1 pr-4" for="date_to">To</label>
                    ...
                    <a href="{{ route('management.clockin-out.download') }}" class="block sm:w-2/12 text-center text-white bg-green-700 hover:bg-green-500 mb-1 ml-10 p-2 rounded">Download</a>
                </div>
                @if ($time_trackings)
