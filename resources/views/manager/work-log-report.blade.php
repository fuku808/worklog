        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('management.work-log.report') }}" class="form" method="GET">
                <div class="flex sm:items-center flex-col sm:flex-row px-2 mb-4">
                    ...
                    <a href="{{ route('management.work-log.download') }}" class="block sm:w-2/12 text-center text-white bg-green-700 hover:bg-green-500 mb-1 ml-10 p-2 rounded">Download</a>
                </div>
                @if ($work_logs)
